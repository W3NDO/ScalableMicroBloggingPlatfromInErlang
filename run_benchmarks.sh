...
do
    ...
    erl -noshell -s -eval "distributed_benchmark:test_system_load($i,$NUMBER_OF_MESSAGES_SENT)" -s init stop > "firefly_benchmarks/experiment3/exp3-test-system-load-$i.csv"
    echo "---"
done
